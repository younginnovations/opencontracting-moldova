...
mongoexport -d $DATABASE -c tmp_contracts_summary --type=csv --fields id,title,description,status,tenderID,tenderTitle,goods,goodsCPV,contractorID,contractor,procuringAgencyID,procuringAgency,contractStartDate,contractEndDate,amount --out /home/moldova-ocds/demo/current/public/csv/contracts_csv.csv
...
mongoexport -d $DATABASE -c tmp_tenders_summary --type=csv --fields tender_id,title,description,procuringEntity,status,procurementMethod,tender_start_date,tender_end_date --out /home/moldova-ocds/demo/current/public/csv/tenders_csv.csv
