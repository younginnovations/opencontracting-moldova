...
mongoexport -d $DATABASE -c tmp_agencies_summary --type=csv --fields name,address,email,phone,url --out /home/moldova-ocds/demo/current/public/csv/agencies_csv.csv
mongoexport -d $DATABASE -c tmp_contractors_summary --type=csv --fields name,scheme --out /home/moldova-ocds/demo/current/public/csv/contractors_csv.csv
mongoexport -d $DATABASE -c tmp_contracts_summary --type=csv --fields ocid,id,title,description,status,period/startDate,period/endDate,value/amount,value/currency,dateSigned,items/description,items/id,procuringEntity/name,procuringEntity/id,suppliers/name,suppliers/id --out /home/moldova-ocds/demo/current/public/csv/contracts_csv.csv
mongoexport -d $DATABASE -c tmp_goods_summary --type=csv --fields id,goods_and_services,scheme,cpv_code --out /home/moldova-ocds/demo/current/public/csv/goods_csv.csv
mongoexport -d $DATABASE -c tmp_tenders_summary --type=csv --fields ocid,id,title,description,status,procurementMethod,tenderPeroid/startDate,tenderPeroid/endDate,procuringEntity/name,procuringEntity/id --out /home/moldova-ocds/demo/current/public/csv/tenders_csv.csv
