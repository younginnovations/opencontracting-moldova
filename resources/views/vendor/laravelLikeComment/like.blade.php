<?php
$data = App\Http\Controllers\LikeController::getLikeViewData((string) $like_item_id);
?>
<div class="laravel-like">
    <i id="{{ $like_item_id }}-like"
       ...
       data-item-id="{{ $like_item_id }}" data-vote="1"></i><span
            id="{{ $like_item_id }}-total-like">{{ $data[$like_item_id.'total_like'] }}</span>
    <i id="{{ $like_item_id }}-dislike"
       ...
       data-item-id="{{ $like_item_id }}" data-vote="-1"></i>&nbsp;&nbsp;<span
            id="{{ $like_item_id }}-total-dislike">{{ $data[$like_item_id.'total_dislike'] }}</span>
</div>
