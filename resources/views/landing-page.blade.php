...
<div class="callout banner-section">
    <div class="row column text-center banner-inner">
        <p class="banner-text">Search through <span class="amount">8,397,926,081 </span> Leu
...
<div class="row table-wrapper">
    <table class="responsive hover custom-table">
        ...
        <tr>
            ...
            <td>Can create Scaled and Plate armor at forges, and improve them twice as much.</td>
            <td>000cb414</td>
            <td>50 Smithing</td>
            <td>Elven Smithing</td>
        </tr>
